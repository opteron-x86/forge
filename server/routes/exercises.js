// ═══════════════════════════════════════════════════════════════
//  TALOS — Exercise Library (Offline Fallback)
//
//  This file serves as the OFFLINE FALLBACK for the exercise
//  library. The primary source of truth is the `exercises` table
//  in PostgreSQL, served via GET /api/exercises.
//
//  The frontend loads this immediately (bundled in the PWA), then
//  replaces it with database data when online. This ensures the
//  exercise picker always works, even with no connectivity.
//
//  After running the seed script, this file can be auto-generated
//  from the database via: node scripts/generate-exercise-fallback.js
//
//  IMPORTANT: Do not rename exercises here without also updating
//  the database — workout history references exercise names as
//  plain strings.
// ═══════════════════════════════════════════════════════════════
...
//
// NOTE: This is the offline fallback. The database table
// `exercise_substitutions` is the source of truth post-migration.
// ═══════════════════════════════════════════════════════════════
export const SUBSTITUTIONS = {
  ...
  "Seated DB Shoulder Press": ["Overhead Press", "Arnold Press", "Machine Shoulder Press"],
  ...
  "Cable Lateral Raise": ["DB Lateral Raise", "Machine Lateral Raise", "Single-Arm Cable Lateral Raise"],
  ...
  "Cable Rear Delt Fly": ["Reverse Pec Deck", "Face Pull", "Incline Reverse Fly"],
  "Reverse Pec Deck": ["Cable Rear Delt Fly", "Face Pull", "Seated Reverse Fly"],
  "Incline Reverse Fly": ["Cable Rear Delt Fly", "Reverse Pec Deck", "Seated Reverse Fly"],
  "Seated Reverse Fly": ["Incline Reverse Fly", "Cable Rear Delt Fly", "Reverse Pec Deck"],
  ...
  // ── Quads ──
  "Back Squat": ["Front Squat", "Hack Squat", "Leg Press", "Belt Squat", "Safety Bar Squat"],
  "Front Squat": ["Back Squat", "Hack Squat", "Leg Press", "Belt Squat"],
  "Hack Squat": ["Leg Press", "V-Squat Machine", "Pendulum Squat", "Back Squat"],
  "Leg Press": ["Hack Squat", "Back Squat", "Belt Squat"],
  "Belt Squat": ["Hack Squat", "Leg Press", "V-Squat Machine"],
  "V-Squat Machine": ["Hack Squat", "Pendulum Squat", "Belt Squat"],
  "Pendulum Squat": ["Hack Squat", "V-Squat Machine"],
  "Leg Extension": ["Single-Leg Extension", "Sissy Squat", "Sissy Squat Machine"],
  "Single-Leg Extension": ["Leg Extension"],
  "DB Bulgarian Split Squat": ["Barbell Bulgarian Split Squat", "DB Lunge", "DB Split Squat"],
  "Barbell Bulgarian Split Squat": ["DB Bulgarian Split Squat", "Barbell Lunge"],
  "DB Lunge": ["Barbell Lunge", "DB Walking Lunge", "DB Reverse Lunge"],
  "DB Goblet Squat": ["DB Squat", "Back Squat", "Front Squat"],

  // ── Hamstrings ──
  "Romanian Deadlift": ["DB Romanian Deadlift", "Cable Romanian Deadlift", "Stiff-Leg Deadlift"],
  "DB Romanian Deadlift": ["Romanian Deadlift", "Single-Leg DB RDL", "DB Stiff-Leg Deadlift"],
  "Stiff-Leg Deadlift": ["Romanian Deadlift", "DB Stiff-Leg Deadlift"],
  "Good Morning": ["Romanian Deadlift", "Cable Pull-Through", "DB Good Morning"],
  "Seated Leg Curl": ["Lying Leg Curl", "Standing Leg Curl", "Cable Leg Curl"],
  "Lying Leg Curl": ["Seated Leg Curl", "Standing Leg Curl", "Cable Leg Curl"],
  "Standing Leg Curl": ["Seated Leg Curl", "Lying Leg Curl", "Single-Leg Curl"],
  "Nordic Hamstring Curl": ["Glute-Ham Raise", "Slider Leg Curl"],
  "Glute-Ham Raise": ["Nordic Hamstring Curl", "Lying Leg Curl"],
  "Cable Pull-Through": ["Kettlebell Swing", "Hip Thrust", "Good Morning"],
  "Barbell Hip Thrust": ["Hip Thrust", "DB Hip Thrust", "Hip Thrust Machine"],

  // ── Glutes ──
  "Hip Thrust": ["Barbell Hip Thrust", "Hip Thrust Machine", "DB Hip Thrust", "Glute Drive Machine"],
  "Hip Thrust Machine": ["Hip Thrust", "Glute Drive Machine", "DB Hip Thrust"],
  "Glute Drive Machine": ["Hip Thrust Machine", "Hip Thrust"],
  "DB Hip Thrust": ["Hip Thrust", "Glute Bridge", "Hip Thrust Machine"],
  "Cable Kickback": ["Donkey Kick", "Hip Abduction Machine"],
  "Hip Abduction Machine": ["Cable Hip Abduction", "Banded Walk", "Clamshell"],
  "Cable Hip Abduction": ["Hip Abduction Machine", "Banded Walk"],
  "Glute Bridge": ["Hip Thrust", "DB Hip Thrust", "Single-Leg Glute Bridge"],

  // ── Biceps ──
  "Barbell Curl": ["EZ-Bar Curl", "DB Curl", "Cable Curl", "Machine Curl"],
  "EZ-Bar Curl": ["Barbell Curl", "DB Curl", "Cable Curl"],
  "DB Curl": ["Barbell Curl", "EZ-Bar Curl", "Cable Curl", "Alternating DB Curl"],
  ...
  "Incline DB Curl": ["Seated DB Curl", "Cable Bayesian Curl", "DB Curl"],
  "Preacher Curl": ["Preacher Curl (DB)", "Machine Preacher Curl", "Cable Preacher Curl", "EZ-Bar Spider Curl"],
  "Preacher Curl (DB)": ["Preacher Curl", "Machine Preacher Curl", "Concentration Curl"],
  "Cable Curl": ["Barbell Curl", "EZ-Bar Curl", "Machine Curl"],
  "Cable Bayesian Curl": ["Incline DB Curl", "Single-Arm Cable Curl"],
  "Concentration Curl": ["Preacher Curl (DB)", "Single-Arm Cable Curl"],
  "Machine Curl": ["Cable Curl", "Barbell Curl", "EZ-Bar Curl"],

  // ── Triceps ──
  "Rope Pushdown": ["Straight Bar Pushdown", "V-Bar Pushdown", "Machine Tricep Extension"],
  "Straight Bar Pushdown": ["Rope Pushdown", "V-Bar Pushdown", "Machine Tricep Extension"],
  "V-Bar Pushdown": ["Straight Bar Pushdown", "Rope Pushdown"],
  "Overhead Tricep Extension": ["Overhead Rope Extension", "DB Overhead Extension", "Barbell Overhead Extension"],
  "Overhead Rope Extension": ["Overhead Tricep Extension", "DB Overhead Extension"],
  "DB Overhead Extension": ["Overhead Tricep Extension", "Overhead Rope Extension", "Single-Arm Pushdown"],
