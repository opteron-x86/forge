...
const S = {
  ...
  navBtn: (a) => ({ padding: "10px 16px", borderRadius: 8, border: "none", background: a ? "var(--accent)" : "transparent", color: a ? "var(--accent-text)" : "var(--text-muted)", fontSize: 11, fontWeight: 700, fontFamily: "inherit", cursor: "pointer", letterSpacing: "0.5px", textTransform: "uppercase" }),
  ...
  input: { background: "var(--surface2)", border: "1px solid var(--border2)", borderRadius: 6, padding: "8px 10px", color: "var(--text)", fontSize: 14, fontFamily: "inherit", width: "100%", boxSizing: "border-box", outline: "none" },
  smInput: { background: "var(--surface2)", border: "1px solid var(--border2)", borderRadius: 4, padding: "6px 4px", color: "var(--text)", fontSize: 13, fontFamily: "inherit", width: "100%", textAlign: "center", boxSizing: "border-box", outline: "none" },
  btn: (v = "primary") => ({ padding: "10px 18px", borderRadius: 8, border: v === "ghost" ? "1px solid var(--border2)" : "none", background: v === "primary" ? "var(--accent)" : v === "danger" ? "#dc2626" : "transparent", color: v === "primary" ? "var(--accent-text)" : v === "danger" ? "#fff" : "var(--text-light)", fontSize: 12, fontWeight: 700, fontFamily: "inherit", cursor: "pointer", letterSpacing: "0.5px", textTransform: "uppercase" }),
  ...
  check: (d) => ({ width: 28, height: 28, borderRadius: 6, border: d ? "none" : "1px solid var(--border2)", background: d ? "#166534" : "transparent", color: d ? "#4ade80" : "var(--text-dim)", fontSize: 14, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "inherit" }),
